          ...
          <tbody>
            {favorites.map((article, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link to={`/article/${article._id}`}><button className="btn btn-outline-info btn-sm">View More Details</button></Link>
                  <button  className="btn btn-outline-danger btn-sm" onClick={() => removeFromFavorites(article._id)}>Remove from Favorites</button>
