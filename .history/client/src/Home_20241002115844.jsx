          ...
          <tbody>
            {favorites.map((article, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link to={`/article/${article._id}`}><button className="btn btn-outline-info btn-sm">  View  <span className="fa fa-solid fa-folder-open fa lg" aria-hidden="true"></span></button></Link> 
