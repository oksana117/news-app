          ...
          <tbody>
            {favorites.map((article, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link to={`/article/${article._id}`}><button className="btn btn-outline-info btn-sm">  View  <span className="fa fa-solid fa-magnifying-glass-plus"" aria-hidden="true"></button></Link> 
