        ...
        <tbody>
          {currentRows.map((article, index) => (
            <tr key={index}>
              ...
              <td><button className="btn btn-outline-info" onClick={() => addToFavorites(article)}>Add to Favorites  <span className="fa fa-solid fa-heart fa-lg" aria-hidden="true"></span></button></td>
            </tr>
          ))}
        </tbody>
      </table>
