          ...
          <tbody>
            {favorites.map((article, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link to={`/article/${article._id}`}><button className="btn btn-outline-info btn-sm">  View  <span className="fa-solid fa-magnifying-glass" aria-hidden="true"></span></button></Link> 
