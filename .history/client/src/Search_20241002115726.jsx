        ...
        <tbody>
          {currentRows.map((article, index) => (
            <tr key={index}>
              ...
              <td><button class="btn btn-outline-info" onClick={() => addToFavorites(article)}>Add to Favorites  <span className="fa-solid fa-heart fa-lg" aria-hidden="true"></span></button></td>
            </tr>
          ))}
        </tbody>
      </table>
