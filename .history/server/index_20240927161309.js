...
app.get('/search', (req, res) => {
    ...
    const url = 'https://api.currentsapi.services/v1/search?domain=zdnet.com&keywords=${keywords}&language=en' + 'country=us&' + 'piKey=gQe1OIS07_7klluzmcY3AFSpZefr87YrCVhuFja2nFLx5zyC';
