...
const app = express()
const apiKey1 = 'a75202da158a4619d779cd0c3e641ef2';
...
//add to favourites the article by the user
    ...
    request(url, function (error, response, body) {
        if (error) {
            ...
            try {
                ...
                const cashedResponse = localStorage("cahsedResponse", res.json(parsedBody))
            } catch (e) {
...
//displaying the articles liked by a login user
