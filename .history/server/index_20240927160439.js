...
app.get('/search', (req, res) => {
    ...
    const url2 = 'https://api.currentsapi.services/v1/search?domain = zdnet.com & keywords=Amazon & language=en' +'country=us&' +
        'apiKey=gQe1OIS07_7klluzmcY3AFSpZefr87YrCVhuFja2nFLx5zyC';
