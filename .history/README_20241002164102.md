...
Express server. Then, the server processes the request and perform data manipulations (save,delete,insert) with Mongoose, and sends back the response to the client side. For example, a user wants to serach an article 
